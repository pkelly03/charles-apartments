...
readyState(function() {
    ...
    $.vegas('slideshow', {
        delay: 10000,
        backgrounds: [{
            src: 'img/background/budget-apartment-dublin-background-1.jpg',
            fade: 2000
        }, {
            src: 'img/background/budget-apartment-dublin-background-2.jpg',
            fade: 2000
        }, {
            src: 'img/background/budget-apartment-dublin-background-3.jpg',
            fade: 2000
        }]
    })('overlay');
